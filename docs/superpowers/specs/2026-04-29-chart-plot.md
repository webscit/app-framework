...
- Chart title prop
- Configurable X-axis and Y-axis labels (user-editable via widget parameters)
...
export interface ChartProps {
   ...
   * Configurable by the user via widget parameters.
   */
  yLabel?: string;
  /**
...
- [ ] Task 1: Types
      ...
      - [ ] ChartProps interface (including xLabel and yLabel)
...
- [ ] Task 4: CHART widget definition
      - [ ] Add to defaultWidgets.ts (include yDomain, yLabel, xLabel parameters)
...
- [ ] Task 6: Tests
      ...
      - [ ] renders xLabel on X axis when provided
      - [ ] renders yLabel on Y axis when provided
